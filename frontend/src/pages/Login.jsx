    ...
    >
      ...
      <motion.div variants={itemVariants} className="w-full max-w-md">
        <Card className="w-full p-[40px] md:p-[48px]">
          <h1 className="text-headline-lg font-display font-bold mb-3">Welcome back</h1>
          <p className="text-body-lg text-[var(--color-gray)] mb-[40px]">Enter your details to continue.</p>
        ...
        <p className="mt-[32px] text-center text-[var(--color-gray)] text-body-md">
          ...
          <Link to="/signup" className="font-semibold text-[var(--color-charcoal)] hover:underline">
            Sign up
          </Link>
        </p>
        </Card>
